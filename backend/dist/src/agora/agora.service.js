...
let AgoraService = class AgoraService {
    ...
    generateRtcToken(roomId, userId) {
        ...
        const token = agora_access_token_1.RtcTokenBuilder.buildTokenWithUid(this.appId, this.appCertificate, channelName, uid, agora_access_token_1.RtcRole.PUBLISHER, expireTime);
